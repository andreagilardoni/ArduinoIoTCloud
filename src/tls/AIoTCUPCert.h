...
// unsigned int x509_crt_bundle_len = sizeof(x509_crt_bundle); // FIXME already defined and never used
// TODO instead of writing a constant value for size, write sizeof
