...
public:
  ...
  void setMessage(Message* msg) {} // FIXME not implemented yet
  Decoder::Status feed(uint8_t* buf, size_t &len) { return Decoder::Status::Error; } // FIXME not implemented yet
...
private:
  ...
  ArrayParserState decodeThingGetIdCmdDown(CborValue * param, Message * message);
  ArrayParserState decodeTimezoneCommandDown(CborValue * param, Message * message);
  ArrayParserState decodeThingGetLastValueCmdDown(CborValue * param, Message * message);
