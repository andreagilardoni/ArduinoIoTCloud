...
public:
  ...
  Encoder::Status encode(uint8_t* buf, size_t& len) { return Encoder::Status::Error; } // FIXME not implemented yet
private:
  ...
  CborError encodeThingGetIdCmdUp(CborEncoder * array_encoder, Message * message);
  CborError encodeOtaBeginUp(CborEncoder * array_encoder, Message * message);
  CborError encodeDeviceBeginCmdUp(CborEncoder * array_encoder, Message * message);
