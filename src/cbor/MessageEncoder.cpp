...
CBORMessageEncoder::EncoderState CBORMessageEncoder::handle_EncodeParam(CborEncoder * array_encoder, Message * message)
{
  ...
  case CommandID::OtaBeginUpId:
    ...
    break;
  case CommandID::ThingGetIdCmdUpId:
    error = CBORMessageEncoder::encodeThingGetIdCmdUp(array_encoder, message);
    break;
  case CommandID::DeviceBeginCmdUpId:
    error = CBORMessageEncoder::encodeDeviceBeginCmdUp(array_encoder, message);
    break;
  case CommandID::ThingGetLastValueCmdUpId:
    break;
  case CommandID::OtaProgressCmdUpId:
...
CborError CBORMessageEncoder::encodeThingGetIdCmdUp(CborEncoder * array_encoder, Message * message)
{
...
CborError CBORMessageEncoder::encodeDeviceBeginCmdUp(CborEncoder * array_encoder, Message * message)
{
