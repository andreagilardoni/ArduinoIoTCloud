...
#ifndef ARDUINO_IOT_CLOUD_PROPERTIES_H
#define ARDUINO_IOT_CLOUD_PROPERTIES_H
...
class ArduinoIoTCloudPropertiesClass
{
  public:

             ArduinoIoTCloudPropertiesClass();
    virtual ~ArduinoIoTCloudPropertiesClass() { }
    ...
    inline PropertyContainer& getPropertyContainer() { return _properties; }
